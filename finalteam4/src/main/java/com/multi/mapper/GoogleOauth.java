...
public class GoogleOauth implements SocialOauth {
	    ...
	    private final String GOOGLE_SNS_CLIENT_ID = "414674411151-8otfjo97eobc9r4lk262bvegl1e27so6.apps.googleusercontent.com";
	    private final String GOOGLE_SNS_CALLBACK_URL = "http://localhost:80/auth/google/callback";
	    private final String GOOGLE_SNS_CLIENT_SECRET = "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";
