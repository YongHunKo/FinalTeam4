...
public class NaverLoginController {
  ...
  private String CLIENT_ID = "MAK4QIbORyQCqNxpf2Oc"; //애플리케이션 클라이언트 아이디값";
  private String CLI_SECRET = "jgzzekxRIT"; //애플리케이션 클라이언트 시크릿값";
  ...
  public String testNaver(HttpSession session, Model model) throws UnsupportedEncodingException, UnknownHostException {
    ...
    String redirectURI = URLEncoder.encode("http://127.0.0.1/naver/callback", "UTF-8");
