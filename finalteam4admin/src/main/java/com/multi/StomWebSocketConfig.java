...
public class StomWebSocketConfig implements WebSocketMessageBrokerConfigurer {
	...
	public void registerStompEndpoints(StompEndpointRegistry registry) {
		registry.addEndpoint("/ws").setAllowedOrigins("http://127.0.0.1:8080","http://localhost:8080","http://118.67.131.90/eatadmin","http://118.67.131.90/eatnout", "http://127.0.0.1").withSockJS();
